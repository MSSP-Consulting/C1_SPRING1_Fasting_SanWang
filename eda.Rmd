...
m1 <- lmer(GLUHFast ~ Ind36H + Age + (1 | Name), data=new_data_fasting)
summary(m1)
coef(m1)
...
m2 <- lmer(GLUHFast ~ Ind36H + Age + (Ind36H - 1 | Name), data=new_data_fasting)
summary(m2)
coef(m2)
